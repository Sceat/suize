...
const CYCLES = [
  ...
  {
    intent: 'sui.ask("best route for a 100k USDC → SUI swap right now", consensus: 5)',
    summary: 'Cetus + DeepBook · 58 / 42 split · price impact 0.12%',
    json: { route: ['cetus', 'deepbook'], split: [0.58, 0.42], price_impact_bps: 12, convergence: 0.84, consensus_n: 5 },
    latency_ms: 612,
    consensus: 5,
    convergence: 0.84,
  },
