...
// ported from apps/crash so Deploy shares the same alive-on-paper cursor. The
// OS cursor is hidden on fine pointers (styles.css `cursor: none`); this draws
// the replacement. Touch / coarse-pointer devices render nothing (the OS cursor
// stays `auto` there via the CSS media query). Pure transform animation on two
// layers via rAF — no React re-render per frame, no deps.
// ============================================================================
