...
- [T-043] no expiration check in verify — DONE via GitHub issue #1, merged eb35520 (implementing the fix also surfaced a gap in the draft x402 spec text). Historical row.
