...
IMAGE_NAME="your-org/suize-backend"
...
echo "============================================"
echo ""
echo "Next: roll the cluster to pick up this image"
echo "  1. Bump image.tag in ~/deploy/domains/suize/ (unified backend values.yaml) to \"${TAG}\""
echo "  2. cd ~/deploy && helmfile -f deploy.yaml sync"
echo ""
